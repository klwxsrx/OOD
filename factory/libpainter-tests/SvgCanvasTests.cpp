...
BOOST_FIXTURE_TEST_SUITE(SvgCanvas, SvgCanvas_)
	...
	{
		canvas.DrawEllipse(CPoint(100, 150), 100, 50);
	...
	BOOST_AUTO_TEST_CASE(can_draw_mupltiple_things)
	{
		...
		canvas.DrawEllipse(CPoint(250, 300), 75, 40);

		canvas.SetColor(Color::Green);
		canvas.DrawLine(CPoint(100, 140), CPoint(170, 280));

		canvas.SetColor(Color::Pink);
		canvas.DrawEllipse(CPoint(75, 56), 31, 81);

		canvas.SetColor(Color::Red);
		canvas.DrawEllipse(CPoint(180, 350), 12, 146);

		canvas.SetColor(Color::Yellow);
		canvas.DrawEllipse(CPoint(210, 57), 34, 81);
