...
void CHarmonicListViewModel::onItemChanged()
{
    QVariant modelIndex = m_model->getCurrentItemIndex();
    emit indexChanged(modelIndex.isValid() ? this->index(modelIndex.toInt()) : QModelIndex());
}
