...
public:
	void Fly() override
	{
		cout << "I'm flying with wings!! Number: " << ++m_flyCounter << endl;
	}
private:
	int m_flyCounter = 0;
};
...
public:
	DeckoyDuck()
		: Duck(make_unique<FlyNoWay>(), make_unique<MuteQuackBehavior>(), make_unique<DanceNoWayBehavior>())
	{
	}
	void Display() const override
	{
...
public:
	RubberDuck()
		: Duck(make_unique<FlyNoWay>(), make_unique<SqueakBehavior>(), make_unique<DanceNoWayBehavior>())
	{
	}
	void Display() const override
	{
...
public:
	ModelDuck()
		: Duck(make_unique<FlyNoWay>(), make_unique<QuackBehavior>(), make_unique<DanceNoWayBehavior>())
	{
	}
	void Display() const override
	{
